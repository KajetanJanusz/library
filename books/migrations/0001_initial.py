    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('rented', 'Wypożyczona'), ('returned', 'Zwrócona'), ('overdue', 'Po terminie'), ('pending', 'Zwrot oczekuje na zatwierdzenie')], default='rented', max_length=10)),
